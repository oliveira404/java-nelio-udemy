...
import com.application.boardgame.Piece;
public class Board {
    private int rows;
    private int columns;
    Piece[][] pieces;
    ...
    public Board(int rows, int columns) {
        if (rows < 1 || columns < 1) throw new BoardException("Erro criando tabuleiro, necessario que haja pelo menos 1 linha e uma coluna");
        this.rows = rows;
